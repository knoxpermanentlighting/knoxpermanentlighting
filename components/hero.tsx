...
export function Hero() {
  ...
  return (
    <Section id="hero" className="flex min-h-[92vh] flex-col justify-center pt-24">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <span className="ml-1 text-xs font-semibold uppercase tracking-[0.2em] text-white/50">
          Serving the Wasatch Front, Utah
        </span>
      </div>

      <h1 className="mt-8 max-w-3xl text-5xl font-bold leading-[1.05] tracking-tight text-white sm:text-6xl md:text-7xl">
        Permanent lights.
        <br />
