  ...
  return (
    <Section id="home" className="flex min-h-[92vh] flex-col justify-center pt-44 sm:pt-40">
      <div className="grid items-center gap-12 lg:grid-cols-2">
        ...
        <div className="relative aspect-[4/5] w-full overflow-hidden rounded-3xl shadow-2xl sm:aspect-[5/4]">
          <Image
            src="/photos/house-aerial-rgb.jpg"
            alt="A home outlined in permanent color-changing LED roofline lighting at night"
            fill
            priority
